...
http://d2dwd3ks06zig3.cloudfront.net/customer/bookAppointment?customer_id={customer_id}&product_id={new_customer.product_id}&case_id={encrypted_case_id}
...
{content}
To view the details of your appointment, please click the following link: http://d2dwd3ks06zig3.cloudfront.net/customer/bookedAppointment?customer_id={existing_appointment['customer_id']}&product_id=1&case_id={encrypted_case_id}
Should you need to reschedule or cancel your appointment, please use the links below at your convenience:
Reschedule Your Appointment - http://d2dwd3ks06zig3.cloudfront.net/customer/bookedAppointment?customer_id={existing_appointment['customer_id']}&product_id=1&case_id={encrypted_case_id}
Cancel Your Appointment - http://d2dwd3ks06zig3.cloudfront.net/customer/bookedAppointment?customer_id={existing_appointment['customer_id']}&product_id=1&case_id={encrypted_case_id}
...
Access your portal here: http://d2dwd3ks06zig3.cloudfront.net/  
...
http://d2dwd3ks06zig3.cloudfront.net/customer/bookAppointment?customer_id={customer_id}&product_id={product_id}&case_id={encrypted_case_id}
...
http://d2dwd3ks06zig3.cloudfront.net/customer/appointmentDetails?appointment_id={new_appointment.id}
""")
        try:
...
For further details, please click the following link: 
http://d2dwd3ks06zig3.cloudfront.net/agent/appointmentDetails?appointment_id={new_appointment.id}
""")
...
async def create_customer(customer: AgentAppointmentGenerator, db: Session = Depends(get_db)):
    try:
        ...
        return ResponseModel(message="Appointment link generated succesfully", payload={"link": f"http://d2dwd3ks06zig3.cloudfront.net/customer/bookAppointment?customer_id={customer_id}&product_id={product_id}&case_id={encrypted_case_id}"})
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST, detail=str(e))
